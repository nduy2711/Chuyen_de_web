      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link as={Link} to="/necklace-list">
              List
            </Nav.Link>
            <Nav.Link as={Link} to="/necklace-search">
              Search
            </Nav.Link>
            <Nav.Link as={Link} to="/necklace-filter">
              Filter
            </Nav.Link>
            <Nav.Link as={Link} to="/necklace-add">
              Add
            </Nav.Link>
            <Nav.Link as={Link} to="/necklace-update">
              Update
            </Nav.Link>
            <Nav.Link as={Link} to="/necklace-delete">
              Delete
            </Nav.Link>
          </Nav>
        </Navbar.Collapse>
